    ...
    <div>
      ...
      <main className=" min-h-screen wppCharacters md:px-32 px-4 flex flex-col ">
        ...
        <p className="flex md:w-96 w-80 pt-4 pb-6 mx-auto font-poppins font-medium md:text-sm text-xs text-center text-neutral-500 md:">
          Aqui você pode encontrar todos os heróis, vilões e todos os
          personagens da marvel que você pode imaginar :D
        </p>
        <div className="input-group b-input-pink font-poppins font-normal text-base box h-10 rounded-lg flex md:w-96 w-64 mx-auto bg-transparent border-solid border-2 border-neutral-500">
          <input

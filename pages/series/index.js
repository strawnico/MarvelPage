  ...
  return (
    <div>
      ...
      <main className=" min-h-screen wppSer md:px-32 px-4 flex flex-col ">
        ...
        <div className="input-group b-input-green font-poppins font-normal text-base box h-10 rounded-lg flex md:w-96 w-64 mx-auto bg-transparent border-solid border-2 border-neutral-500">
          <input
